Как установить свое ядро (свою сборку, любую версию) сервера
=============================================================
...
Если сервер не хочет запускаться - проверьте логи, проанализируйте ошибки, убедитесь что сборка работоспособна. Если у вас все таки не получиться самостоятельно решить проблему - пишите запрос в техническую поддержку через `Тикет систему`_.
.. _`Тикет систему`: https://gamehost.abcd.bz/billing/submitticket.php?step=2&deptid=1/
